...
$js_array = ['js/mypage.js', 'js/search_zipcode.js', 'js/upload_profile.js', 'js/secure_function.js'];
$menu_code = 'myPage';
$g_title="My Page";
  ...
  <form name="input_form" method="post" enctype="multipart/form-data" autocomplete="off" action="pg/member_process.php">
    ...
    <div class="form-group mt-3 d-flex gap-2 justify-content-between">
      <div class="w-50">
        ...
        <input type="text" class="form-control" name="f_addr1" id="f_addr1" value="<?= $memArr['addr1'] ?>" readonly>
      </div>

      <div class="w-50">
        <label for="f_addr2" class="form-label">상세 주소</label>
        <input type="text" class="form-control" name="f_addr2" id="f_addr2" value="<?= $memArr['addr2'] ?>">
      </div>
    </div>
