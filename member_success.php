...
<main class="w-75 mx-auto border rounded-5 d-flex flex-column" style="min-height: calc(100vh - 277px);">
  ...
  <div class="p-5 d-flex gap-5 flex-grow-1 align-items-center">
    ...
    <div>
      <h3>회원가입을 축하드립니다.</h3>
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta perspiciatis reiciendis voluptate excepturi
        architecto saepe facilis, libero, hic sequi, distinctio quisquam odit amet accusantium iusto corporis labore
        ipsam sed quia?</p>
